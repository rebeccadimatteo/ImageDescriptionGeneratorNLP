...
def resize_image(input_path, target_size=(299, 299), output_format='JPEG'):
    try:
...
def generate_description(features, max_len=53, temperature=1.0):
    description = []
...
input_image_path = 'C:\\Users\\becca\\PycharmProjects\\ImageDescriptionGeneratorNLP\\outputImages\\13327175.jpg'
